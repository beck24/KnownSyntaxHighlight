...
<script>
    ...
    function makeRichText(container) {
        $(container).tinymce({
            ...
            menubar: false,
            height: <?=$height?>,
            toolbar: 'styleselect | bold italic | link image | blockquote bullist numlist | alignleft aligncenter alignright | code | sh4tinymce',
            plugins: 'code link image autoresize sh4tinymce',
            relative_urls : false,
